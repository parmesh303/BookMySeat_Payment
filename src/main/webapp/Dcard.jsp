...
<body>
<div class="row">
<form  action="debitcard">
<h3>Payment</h3>
            <label for="cname">Name </label>
            <input type="text" id="cname" name="cardname" placeholder="Name On Cars..."><br>
            <label for="ccnum">debit card number</label>
            <input type="text" id="ccnum" name="cardnumber" placeholder="Your Cardnumber..."><br>
            <label for="expmonth">Exp Month</label>
            <input type="text" id="expmonth" name="expmonth" placeholder="Card Exp-pmonth..." ><br>
            <label for="expyear">Exp Year</label>
            <input type="text" id="expyear" name="expyear" placeholder="Card Exp-year..."><br>
